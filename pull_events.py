...
# export GOOGLE_APPLICATION_CREDENTIALS="/home/shirley_cohen/traffic-demo-5c701f9abafe.json"
...
while True:
    ...
    socrata_client = Socrata("data.cityofchicago.org", APP_TOKEN, username="shirley.cohen@gmail.com", pass
word="K/+z2;g;a<6g6qk-")

    # get up to 500,000 results, returned as JSON from API / converted to Python list of dictionaries by s
odapy.
